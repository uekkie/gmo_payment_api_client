...
# Unit tests for GmoPaymentApiClient::Card
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GmoPaymentApiClient::Card do
  let(:instance) { GmoPaymentApiClient::Card.new }

  describe 'test an instance of Card' do
    it 'should create an instance of Card' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GmoPaymentApiClient::Card)
    end
  end
